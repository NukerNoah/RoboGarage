data:extend({
{
  ...
  },
  {
    ...
    idle =
    {
      filename = "__RoboGarage__/graphics/entity/logistic-robot/logistic-robot.png",
      priority = "high",
      line_length = 16,
      width = 27,
      height = 28,
    ...
    shadow_idle =
    {
      filename = "__RoboGarage__/graphics/entity/logistic-robot/logistic-robot-shadow.png",
      priority = "high",
      line_length = 16,
      width = 45,
      height = 18,
...

  {
    ...
    idle =
    {
      filename = "__RoboGarage__/graphics/entity/construction-robot/construction-robot.png",
      priority = "high",
      line_length = 16,
      width = 24,
      height = 27,
    ...
    shadow_idle =
    {
      filename = "__RoboGarage__/graphics/entity/construction-robot/construction-robot-shadow.png",
      priority = "high",
      line_length = 16,
      width = 37,
      height = 18,
    ...
    working =
    {
      filename = "__RoboGarage__/graphics/entity/construction-robot/construction-robot-working.png",
      priority = "high",
      line_length = 2,
      width = 21,
      height = 27,
